...
interface ShardHashFunction {
  fun hash(value: String): Long
}

/**
 * MurmurHash3 x86 32-bit port (returns unsigned 32-bit in Long).
 *
 * Deterministic and fast enough for consistent routing / shard selection.
 */
class MurmurHash3Function : ShardHashFunction {
