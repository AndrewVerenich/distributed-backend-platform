package com.andver.saga.participant

import com.andver.saga.model.SagaCommand
import com.andver.saga.model.SagaReply
import com.andver.saga.participant.consumer.SagaCommandConsumer
...
@AutoConfiguration
@EnableKafka
@ConditionalOnProperty(prefix = "saga.participant", name = ["enabled"], havingValue = "true", matchIfMissing = false)
class SagaParticipantAutoConfiguration(
  ...
  fun sagaReplyProducer(
    ...
    @Value("\${saga.participant.reply-topic:saga.reply}") replyTopic: String
  ): SagaReplyProducer {
  ...
  fun sagaCommandConsumerFactory(): ConsumerFactory<String, SagaCommand> {
    ...
    props[JsonDeserializer.TRUSTED_PACKAGES] = "com.andver.saga.model"
